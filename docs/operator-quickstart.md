# Operator Quickstart — Retail sale of automotive fuel

Shortest path from clone to a verified local dry-run for **ISIC 4730** (`cloud-itonami-isic-4730`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-4730.git
cd cloud-itonami-isic-4730
```
...
- Blueprint governor key: `forecourt-safety-governor`
- Likely source path: `forecourt.governor.cljc`
